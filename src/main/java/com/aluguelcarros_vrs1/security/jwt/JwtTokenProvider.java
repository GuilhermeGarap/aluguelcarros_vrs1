...
import com.aluguelcarros_vrs1.infra.exception.InvalidJwtAuthenticationException;
...
public class JwtTokenProvider {
    ...
    public ResponseTokenDTO createAcessToken(String userName, List<String> roles) {
        Date now = new Date();
